...
public class TokenFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        if (url.indexOf("/index/registerWeb") != -1) {
            return false;
        }
        if (url.indexOf("/system/getWeekPriceRate") != -1) {
            return false;
        }
        if (url.indexOf("/system/getVerifyCode") != -1) {
            return false;
        }
        if (url.indexOf("/system/update") != -1) {
            return false;
        }
        ...
        if (url.indexOf("/manage/authentication") != -1) {
            return false;
        }
        //游戏授权
