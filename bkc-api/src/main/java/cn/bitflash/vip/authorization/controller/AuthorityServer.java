    ...
    public R toShowUser(Model model, HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        try {
            ...
            if (null != userEmpowerEntity) {
                ...
                UserInfoEntity userInfoEntity = authorityFeign.selectUserInfoByMobile(mobile);

                if(null != userInfoEntity) {
                    AuthorityUserEntity AuthorityUser = authorityFeign.selectAuthorityByUid(userInfoEntity.getUid());
                    if(null == AuthorityUser) {
                        ...
                        authorityFeign.insertAuthority(authorityUserEntity);
                    }
